...
class Database:
    ...
    def convertir_feuilles_en_table(self, classeur, nom_feuille):
        """
    ...
    def diff_entre_deux_listes(self, l1, moins_l2):
        return [x for x in l1 if x not in moins_l2]

    def calculer_clef_ligne(self, ligne):
        import hashlib
    ...
    def purifier_sql(self, sql: str) -> str:
        if sql is None:
            return None
    ...
    def fermer_projet(self, root=None):
        """
    ...
    def traiter_classeur(self, classeur, l_sauf=None):
        """
        ...
        try:
            for nom_feuille in l_feuilles:
                ...
                l_noms_tables.append(
                    self.convertir_feuilles_en_table(classeur, nom_feuille))
