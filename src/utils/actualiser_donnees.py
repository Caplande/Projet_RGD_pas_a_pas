...
def copier_donnees(nom_source, nom_cible, correspondance_noms=None, correspondance_source_types=None, correspondance_cible_types=None):
    classe_source = u_sql.extraire_classe_depuis_nom_table(nom_source)
    classe_cible = u_sql.extraire_classe_depuis_nom_table(nom_cible)
    table_source = u_sql.extraire_table_depuis_nom_table(nom_source)
    table_cible = u_sql.extraire_table_depuis_nom_table(nom_cible)
...
def mettre_en_forme_bdd():
    u_sql.mettre_a_jour_Base()
    u_sql.vider_table("t_data")
    u_sql.vider_table("t_parametres")
