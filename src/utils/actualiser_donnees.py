...
"""
    ...
    # 2.4.6) Ajouter une colonne exercice TEXT(4) à tampon_data, la calculer ensuite
    u_sql_2.ajouter_calculer_colonne_exercice_tampon_data()

    # 2.5) t_base_data: Merger tampon_data et t_agregation dans t_base_data (tablee à creer)
    u_sql_2.creer_peupler_table_fusion("t_agregation", "tampon_data")
    #      A ce stade t_base_data a sa colonne rang_doublon valorisée à 0 et sa colonne groupe partiellement valorisée. Elle ne dispose pas nonplus de colonne batrub
